...
import th.ac.kmutt.cpe.algorithm.wisit.lab.lab5.fee.FeeSearchStrategy;
import th.ac.kmutt.cpe.algorithm.wisit.lab.lab5.fee.CSVReader;
import java.util.ArrayList;
import java.util.Collections;
import java.util.Comparator;
import java.util.List;

public class BinarySearchStrategy implements FeeSearchStrategy {
